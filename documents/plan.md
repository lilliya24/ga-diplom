...
- Поле "Владелец" - имя и фамилия (например: Иванов Иван)
...
7. _Отправка формы с невалидными данными в поле “Номер карты" 4444 4444 4444 4441 (ввести меньше 16 символов (например 15));_
...
12. _Отправка формы с невалидными данными  поле "Месяц" оставить пустым;_
...
13. _Отправка формы с невалидными данными в поле "Год"(прошедшая дата);_
...
14. _Отправка формы  с невалидными данными в поле "Год"(больше 5 лет);_
...
15. _Отправка формы  с невалидными данными поле "Год" оставить пустым;_
+ Действия: Оставить поле год пустым;
+ Остальные  поля заполнить валидными данными:
+ Ожидаемый результат: cообщение об ошибке:"Неверный формат"


16. _Отправка формы с невалидным значением в поле "Владелец" (ввести цифры 12345);_
+ Действия: заполнить поле "владелец" невалидными данными,(ввести цифры 12345);
+ Остальные поля заполнить валидными данными:
+ Ожидаемый результат: cообщение об ошибке "Неверный формат"


17. _Отправка формы с невалидным значением в поле "Владелец" (ввести спец.символы ?,%);_
+ Действия: заполнить поле "владелец" невалидными данными (ввести спец.символы ?,%);
+ Остальные поля заполнить валидными данными:
+ Ожидаемый результат: cообщение об ошибке "Неверный формат"


18. _Отправка формы с невалидным значением в поле "Владелец" (дефис в начале и конце -Иванов; Иванов-);_
...
19. _Отправка формы  с невалидными данными в поле "Владелец" (Один символ в имени и фамилии И И);_"
...
20. _Отправка формы  с невалидными данными в поле "Владелец" (Поле "Владелец" оставить пустым);_
...
21. _Отправка формы с невалидными данными в поле СVC (ввести меньше 3 цифр) ;_
...
22. _Отправка формы с невалидными данными в поле СVC (ввести 000);_
...
23. _Отправка формы с невалидными данными  поле СVC оставить пустым;_
